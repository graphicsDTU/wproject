 ...
 * @return Vector3 specifying the imaginary part
 */
Quaternion.prototype.get_imag = function () {
  var e = this.elements;
  var v = new Vector3();
  var result = v.elements;
  result[0] = e[0]; result[1] = e[1]; result[2] = e[2];
  return v;
};
...
Quaternion.prototype.make_rot_angle_axis = function (angle, vec) {
  var e = this.elements;
  var v = vec.normalize()*Math.sin(angle);
 ...
 * @param vec1 The Vector3 we are rotating from
 * @param vec2 The Vector3 we are rotating to
 * @return this
 */
Quaternion.prototype.make_rot_vec2vec = function (vec1, vec2) {
  var e = this.elements;
  var a = vec1.elements;
  var b = vec2.elements;

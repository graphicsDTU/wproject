...
var modelViewMatrixLoc, projection, typicalMatrLocat;
var orbit = true;
...
function createSphere(gl,numTimesToSubdivide){
    ...
    typicalMatrLocat = gl.getUniformLocation( gl.program, "nMatrix" );
...
window.onload = function init() {
    ...
    var incrementBtn = document.getElementById("increaseBtn");
    var decrementBtn = document.getElementById("decreaseBtn");
    var orbitBtn = document.getElementById("orbit");
    var slider_le = document.getElementById("slider_le");
    var slider_kd = document.getElementById("slider_kd");
    var slider_ka = document.getElementById("slider_ka");
    var slider_ks = document.getElementById("slider_ks");
    var slider_alpha = document.getElementById("slider_alpha");

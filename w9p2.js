...
function WebGLStart() {
    ...
    phi = 0;
    theta = 0;
    var teapot = document.getElementById("toggle-teapot")
    teapot.onclick = function () {
        moveTeapot = !moveTeapot;
    };
    var Tlight = document.getElementById("toggle-light")
    Tlight.onclick = function () {
        moveLight = !moveLight;
    };
    ...
    requestAnimationFrame(function render() {
        ...
        gl.uniform3fv(programInfo.u_light_world, flatten(lightR));
        gl.drawArrays(gl.TRIANGLES, 6, positions.length - 6);

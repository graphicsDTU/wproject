...
var viewMatrixLoc, projectionMatrLocat, typicalMatrLocat;
var texSize = 64;
var numRows = 4;
var numCols = 4;
...
window.onload = function init() {
  ...
  projectionMatrLocat = gl.getUniformLocation(gl.program, "projection");
...
var render = function () {
  ...
  gl.uniformMatrix4fv(projectionMatrLocat, false, flatten(projection));
